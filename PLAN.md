...
### Фаза 2: Диагностика, баланс и расширенные функции [ЗАПЛАНИРОВАНО]
- [ ] **Канал здоровья и готовности модема**:
...
- [ ] **Автоматическая диагностика сбоев**:
...
- [ ] **Пресеты операторов для контроля баланса**:
...
- [ ] **Тарифный менеджер и учёт лимитов**:
...
### Фаза 3: Масштабирование и расширенные платформы [БУДУЩЕЕ]
- [ ] Пул из нескольких модемов (Multi-modem: балансировка нагрузки, резервирование SIM).
- [ ] Поддержка RISC-V архитектуры.
- [ ] Экспорт метрик Prometheus (`/metrics`).
